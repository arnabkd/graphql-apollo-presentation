...
export type PetInfoFragment = { __typename?: 'Person', pets: Array<{ __typename?: 'Cat', beLazy: string, id: string, name: string, makeSound: string } | { __typename?: 'Dog', barkLoudly: string, id: string, name: string, makeSound: string }> };

export const PetInfoFragmentDoc = gql`
    fragment petInfo on Person {
  pets {
    id
    name
    makeSound
